...
import app.model.AterrizarImple;
...
public class AterrizarImpleTest
{
	...
	public void setUp() throws Exception
	{
		...
		busqueda = new Busqueda(buenosAires, losAngeles, fechaSalida2, horaSalida2, fechaLlegada2, horaLlegada2, claseNula, ubicacionNula, null, null, new SinCriterio(), null, null);
